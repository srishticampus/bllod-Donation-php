...
if($id==""){
  ...
  <a href="signup.php" class="get-started-btn" >REGISTER</a>
       <a href="signin.php" class="get-started-btn" >LOGIN</a>
 ...
 <a href="../Tutor/tutor-login.php">TUTOR</a>
  ...
  echo '<nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="courses.php">SUBJECTS</a></li>
          <li><a href="view_materials.php">MATERIALS</a></li>

          <li><a href="trainers.php">TRAINERS</a></li>
          <li><a href="events.php">ONLINE TEST</a></li>
          <li><a href="email.php">MAIL</a></li>
