...
.mailbox-widget .custom-tab .nav-item .nav-link.active {
    background: 0 0;
    color: #fff;
    border-bottom: 3px solid #140fa3;
}
...
<div class="container">
    <div class="row">
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-body bg-primary1 text-white mailbox-widget pb-0" style="background-color: #140fa3">
...
Left JOIN request ON tutor_registration.tutor_id=request.tutor_id Left JOIN democlass ON request.request_id=democlass.request_id where request.status ='Approved' and request.payment_status='Payment Approved' and democlass.stud_id='$id'";
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="link" href="javascript: void(0)">
                                                    ...
                                                    <span class="text-dark"><?php echo $row['type']?>  
<?php
