...
$sql="select * from tutor_registration where stud_id='$tutor_id'";
...
$sql2="INSERT INTO `democlass`( `stud_id`, `date`, `time`, `current_date`, `current_time`, `type`,`request_id`) VALUES ($value,'$date','$full','$currentDate','$currentTime','Exam','$request_id')";
$result2=$con->query($sql2);
}
$count=$con->affected_rows;

if($count>0){
	header('location:onlinetest.php?success');
}
 else {

 header('location:onlinetest.php?failed');
}
